...
export function QRScanner({
  ...
  return (
    <>
      ...
      <div className={cn('overflow-hidden rounded-lg bg-black', showPreview && `w-[${previewSize}px] h-[${previewSize}px]`)}>
        <div id={elementId} className={cn('w-full', showPreview ? 'aspect-square' : 'hidden')} />
      </div>
