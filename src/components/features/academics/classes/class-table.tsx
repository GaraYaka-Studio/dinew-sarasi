            ...
            <TableRow key={item.id}>
              ...
              <TableCell>
                <div className="flex flex-col text-sm">
                  ...
                  <span className="text-xs text-muted-foreground">{item.schedule.time}</span>
                </div>
              </TableCell>
              <TableCell>
                <span className="font-semibold">LKR {item.fee.toLocaleString()}</span>
              </TableCell>
              <TableCell>
              ...
              <TableCell className="text-right">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="ghost" size="icon" title="View Class Sheet">
                       <Eye className="h-4 w-4" />
                       <span className="sr-only">View Class Sheet</span>
                    </Button>
                  </DialogTrigger>
                  <DialogContent>
                    <DialogHeader>
