      ...
      {data.map((item) => (
        ...
        >
          ...
          <div className="flex items-start justify-between">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem>Edit Class (Coming Soon)</DropdownMenuItem>
                <DropdownMenuSeparator />
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-bold">LKR {item.fee.toLocaleString()}</span>
          </div>

          {/* Line 4: Schedule + Count */}
          <div className="flex items-center justify-between text-sm pt-2 border-t mt-1">
