    ...
    return (
        <div className={cn('flex flex-col space-y-4', className)}>
            ...
            <div className="px-3 py-2">
                ...
                <Button
                    variant={
                        activeFilter.type === 'all' ? 'secondary' : 'ghost'
                    }
                    className={cn(
                    ...
                    onClick={() =>
                        onSelectFilter({ type: 'all', value: 'All Classes' })
                    }
                >
                            ...
                            <AccordionTrigger
                                className={cn(
                                    ...
                                    activeFilter.type === 'category' &&
                                        activeFilter.value === section.category
                                ...
                                <div className="space-y-1">
                                    {section.grades.map((grade) => (
                                        <Button
                                            ...
                                            size="sm"
                                            className={cn(
                                                'h-9 w-full justify-start pl-11 font-normal text-muted-foreground',
                                                activeFilter.type === 'grade' &&
                                                    activeFilter.value === grade
