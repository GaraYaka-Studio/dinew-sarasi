...
async function createSuperAdmin() {
	...
	if (!userId || !email) {
		...
		console.log('');
		console.log('Usage: npx tsx scripts/create-super-admin.ts <USER_ID> <EMAIL> [FULL_NAME]');
		console.log('');
		...
		console.log(`6. Run: npx tsx scripts/create-super-admin.ts "<USER_ID>" "email@example.com" "Full Name"`);
		console.log('');
		process.exit(1);
	}
